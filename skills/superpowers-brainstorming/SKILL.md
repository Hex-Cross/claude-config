...
description: "You MUST use this before any creative work - creating features, building components, adding functionality, or modifying behavior. Explores user intent, requirements and design before implementation. Usage: /superpowers-brainstorming [feature or task description]"
user-invocable: true
---

# Brainstorming Ideas Into Designs: $ARGUMENTS
